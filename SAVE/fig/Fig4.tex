...
\addplot +[ hist={bins=50}, black, fill=black!50]
  table [y index=4, col sep=comma] {figures/application_save/random_control/all.csv};
...
\addplot +[ hist={bins=50}, black, fill=black!50]
  table [y index=5, col sep=comma] {figures/application_save/random_control/all.csv};
%draw vertical bar gray
\draw[gray, ultra thick, dashed]
...
\addplot +[ hist={bins=50}, black, fill=black!50]
  table [y index=4, col sep=comma] {figures/application_save/mpc_control/all.csv};
%draw vertical bar gray
\draw[gray, ultra thick, dashed]
...
\addplot +[ hist={bins=50}, black, fill=black!50]
  table [y index=5, col sep=comma] {figures/application_save/mpc_control/all.csv};
%draw vertical bar gray
\draw[gray, ultra thick, dashed]
...
%draw histogram
\addplot +[ hist={bins=50}, black, fill=black!50]
  table [y index=4, col sep=comma] {figures/application_save/integral_control/all.csv};
%draw vertical bar
\draw[gray, ultra thick, dashed]
...
%draw histogram
\addplot +[ hist={bins=50}, black, fill=black!50]
  table [y index=5, col sep=comma] {figures/application_save/integral_control/all.csv};
%draw vertical bar gray
\draw[gray, ultra thick, dashed]
...
%draw histogram
\addplot +[ hist={bins=50}, black, fill=black!50]
  table [y index=4, col sep=comma] {figures/application_save/greedy_control/all.csv};
%draw vertical bar
\draw[gray, ultra thick, dashed]
...
%draw histogram
\addplot +[ hist={bins=50}, black, fill=black!50]
  table [y index=5, col sep=comma] {figures/application_save/greedy_control/all.csv};
%draw vertical bar gray
\draw[gray, ultra thick, dashed]
...
\end{groupplot}
\end{tikzpicture}
\caption{SAVE adaptation over the Youtube dataset with different techniques: Random, MPC, Integral, and $\epsilon$-Greedy.\vspace{1.3mm}}
\label{fig:SAVEhistograms}
\end{figure*}
